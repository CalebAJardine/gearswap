...
function init_gear_sets()
    ...
    sets.precast.FC = {main={ name="Queller Rod", augments={'MP+80','"Cure" potency +15%','Enmity-5',}},
    sub="Thuellaic Ecu +1",
    ammo="Sapience Orb",
	...
	sets.precast.FC.Cure.DT = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Defending Ring",ring2="Lebeche Ring",
		back="Perimede Cape",waist="Witful Belt",legs="Ebers Pant. +1",feet="Hygieia Clogs +1"}
	...
	sets.midcast.Cure = { main={ name="Queller Rod", augments={'MP+80','"Cure" potency +15%','Enmity-5',}},
    sub="Thuellaic Ecu +1",
    ...
    back="Solemnity Cape",
		...
		sets.midcast.CureSolace = { main={ name="Queller Rod", augments={'MP+80','"Cure" potency +15%','Enmity-5',}},
		sub="Thuellaic Ecu +1",
		ammo="Ombre Tathlum +1",
		head={ name="Vanya Hood", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
		body="Ebers Bliaud +1",
	...
	sets.midcast.LightDayCure = {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		...
		sets.midcast.Curaga = { main={ name="Queller Rod", augments={'MP+80','"Cure" potency +15%','Enmity-5',}},
		sub="Thuellaic Ecu +1",
		ammo="Ombre Tathlum +1",
		head={ name="Vanya Hood", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
		body="Ebers Bliaud +1",
	...
	sets.midcast.MeleeCure = { main={ name="Queller Rod", augments={'MP+80','"Cure" potency +15%','Enmity-5',}},
    sub="Thuellaic Ecu +1",
    ammo="Ombre Tathlum +1",
    head={ name="Vanya Hood", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
    body="Ebers Bliaud +1",
