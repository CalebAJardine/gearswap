...
function init_gear_sets()
	...
	sets.precast.FC = {main={ name="Solstice", augments={'Mag. Acc.+20','Pet: Damage taken -4%','"Fast Cast"+5',}},
		range="Dunna",
		head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+13','Magic burst dmg.+11%','CHR+8',}},
		body={ name="Merlinic Jubbah", augments={'Mag. Acc.+30','Magic burst dmg.+6%','MND+9','"Mag.Atk.Bns."+12',}},
    ...
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+30','Magic burst dmg.+6%','MND+9','"Mag.Atk.Bns."+12',}},
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+5','"Fast Cast"+5','CHR+1','"Mag.Atk.Bns."+10',}},
    legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+4 "Mag.Atk.Bns."+4','Magic burst dmg.+10%','Mag. Acc.+3','"Mag.Atk.Bns."+4',}},
    feet={ name="Merlinic Crackows", augments={'"Mag.Atk.Bns."+17','"Fast Cast"+7','Mag. Acc.+2',}},
    neck="Loricate Torque +1",
    waist="Witful Belt",
    left_ear={ name="Moonshade Earring", augments={'Accuracy+4','TP Bonus +250',}},
