...
function init_gear_sets()
    ...
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+1','"Drain" and "Aspir" potency +9','"Mag.Atk.Bns."+13',}},
    legs="Ea slops +1",
    ...
    sets.midcast.Drain = {ammo="Dosis Tathlum",
    head="Ea Hat +1",
    body="Ea Houppelande +1",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+1','"Drain" and "Aspir" potency +9','"Mag.Atk.Bns."+13',}},
    legs="Ea slops +1",
    ...
    sets.midcast['Elemental Magic'] = {main={ name="Lathi", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Niobid Strap",
    ammo="Dosis Tathlum",
    head="Ea Hat",
    --body="Ea houppelande +1",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main={ name="Lathi", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Niobid Strap",
    ammo="Dosis Tathlum",
    head="Ea Hat",
    --body="Ea houppelande +1",
	...
	sets.ResistantMagicBurst = {head="Ea Hat",body="Ea houppelande +1",hands="Amalric Gages +1",ring1="Mujin Band",legs="Ea slops +1",feet="Jhakri Pigaches +2"}
	sets.RecoverBurst = {head="Ea Hat",neck="Mizu. Kubikazari",body="Spaekona's Coat +3",hands="Amalric Gages +1",ring1="Mujin Band",legs="Ea slops +1",feet="Jhakri Pigaches +2"}
	sets.ResistantRecoverBurst = {head="Ea Hat",neck="Mizu. Kubikazari",body="Spaekona's Coat +3",hands="Amalric Gages +1",ring1="Mujin Band",legs="Ea slops +1",feet="Jhakri Pigaches +2"}
