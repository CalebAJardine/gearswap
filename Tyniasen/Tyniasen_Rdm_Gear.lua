...
function init_gear_sets()
	...
	sets.precast.FC = {main="Demersal Degen",
    ...
    sets.midcast.Cure = { main={ name="Nibiru Cudgel", augments={'MND+10','Mag. Acc.+15','"Cure" potency +15%',}},
    head={ name="Vanya Hood", augments={'MP+50','"Fast Cast"+10','Haste+2%',}},
    ...
    sets.midcast.LightWeatherCure = { main={ name="Nibiru Cudgel", augments={'MND+10','Mag. Acc.+15','"Cure" potency +15%',}},
    head={ name="Vanya Hood", augments={'MP+50','"Fast Cast"+10','Haste+2%',}},
    body={ name="Vanya Robe", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
    hands={ name="Vanya Cuffs", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
    legs={ name="Vanya Slops", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
	...
	sets.midcast['Enfeebling Magic'] = {main="Eletta Rod",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Eletta Rod",
    head={ name="Chironic Hat", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','MND+5','Mag. Acc.+6',}},
    body={ name="Vanya Robe", augments={'MP+50','"Cure" potency +7%','Enmity-6',}},
    hands={ name="Chironic Gloves", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','CHR+6','Mag. Acc.+9',}},
    legs={ name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Cure" potency +5%','CHR+10','Mag. Acc.+7','"Mag.Atk.Bns."+11',}},
    ...
    sets.midcast['Elemental Magic'] = {main="Eletta Rod",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+27','"Occult Acumen"+7','CHR+14','"Mag.Atk.Bns."+10',}},
    body="Jhakri Robe +2",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+19','Magic burst dmg.+8%','"Mag.Atk.Bns."+1',}},
    legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+10 "Mag.Atk.Bns."+10','Magic burst dmg.+10%','CHR+7','Mag. Acc.+8','"Mag.Atk.Bns."+11',}},
    feet={ name="Merlinic Crackows", augments={'Magic burst dmg.+11%','Mag. Acc.+9','"Mag.Atk.Bns."+8',}},
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		...
		back="Umbra Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet=gear.merlinic_refresh_feet}
	...
	sets.idle.PDT = {main="Terra's Staff",sub="Oneiros Grip",ammo="Staunch Tathlum",
		...
		back="Umbra Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Gende. Galosh. +1"}
	...
	sets.idle.MDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
		...
		back="Engulfer Cape +1",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Gende. Galosh. +1"}
	...
	sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		...
		body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
		back="Umbra Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet=gear.chironic_refresh_feet}
