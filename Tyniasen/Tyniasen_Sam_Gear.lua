...
function init_gear_sets()
    ...
    head="Flam. Zucchetto +2",
    body={ name="Valorous Mail", augments={'Attack+21','Weapon skill damage +5%','Accuracy+12',}},
    hands={ name="Valorous Mitts", augments={'Attack+28','Weapon skill damage +3%','STR+11','Accuracy+1',}},
