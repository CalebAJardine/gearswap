...
function init_gear_sets()
    ...
    sub="Willpower Grip",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','INT+4','Mag. Acc.+15',}},
    body="Jhakri Robe +2",
    ...
    back={ name="Lugh's Cape", augments={'Mag. Acc+20 /Mag. Dmg.+20',}},}

    sets.midcast['Elemental Magic'].Resistant = {main={ name="Akademos", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Willpower Grip",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','INT+4','Mag. Acc.+15',}},
    body="Jhakri Robe +2",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+19','Magic burst dmg.+8%','"Mag.Atk.Bns."+1',}},
    ...
    sets.midcast['Elemental Magic'].Fodder = {main={ name="Akademos", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Willpower Grip",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','INT+4','Mag. Acc.+15',}},
    body="Jhakri Robe +2",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+19','Magic burst dmg.+8%','"Mag.Atk.Bns."+1',}},
    ...
    sets.midcast['Elemental Magic'].Proc = {main={ name="Akademos", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Willpower Grip",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','INT+4','Mag. Acc.+15',}},
    body="Jhakri Robe +2",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+19','Magic burst dmg.+8%','"Mag.Atk.Bns."+1',}},
    ...
    sets.midcast['Elemental Magic'].OccultAcumen = {main={ name="Akademos", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    sub="Willpower Grip",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','INT+4','Mag. Acc.+15',}},
    body="Jhakri Robe +2",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+19','Magic burst dmg.+8%','"Mag.Atk.Bns."+1',}},
