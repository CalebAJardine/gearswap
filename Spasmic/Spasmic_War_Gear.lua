function user_setup()
	...
	state.Weapons:options('ProcKill', 'ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcClub','ProcStaff', 'ProcKill')
	...
	send_command('bind !r gs c cycle Weapons')
...
function init_gear_sets()
	...
	sets.idle = {ammo="Staunch Tathlum",
		head="Genmei Barbuta",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Ethereal Earring",
...
-- Ragnarok melee sets
	...
	-- Weapons sets
	sets.weapons.ProcKill = {main="Tanmogayi"}
	sets.weapons.Chango = {main="Chango",sub="Utu Grip"}
	sets.weapons.DualWeapons = {main="Firangi",sub="Reikiko"}
	sets.weapons.Greatsword = {main="Montante +1",sub="Utu Grip"}
	sets.weapons.ProcDagger = {main="Rusty Dagger",sub=empty}
	...
	sets.weapons.ProcKill = {main="Tanmogayi", sub=empty}
